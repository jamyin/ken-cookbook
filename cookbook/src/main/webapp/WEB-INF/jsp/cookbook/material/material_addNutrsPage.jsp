...
<script type="text/javascript">
	...
	function save(){
	    ...
	    if($("#unit").val()==""){
	      ...
	      $.ajax({
	    	  type: "POST",
				url: '<%=basePath%>nutritionController/hasNutrName.do?nutrName='+$("#nutrName").val(),
				dataType:'json',
...
<body>
	<form action="materialController/saveNutr.do" name="materialNutrForm" id="materialNutrForm" method="post">
	   ...
	   <input id="imgUrl" name="imgUrl" type="hidden" value="/upload/aaa" />
		...
		<table>
		    <tr>
			    ...
			    <td><input type="text" name="nutrName" id="nutrName"  maxlength="32" placeholder="这里输入名称" title="名称"/></td>
			</tr>
			<tr>
		        <td style="text-align:left">单位：</td>
				<td><input type="text" name="unit" id="unit"  maxlength="32" placeholder="这里输入单位" title="单位"/></td>
			</tr>
			<tr>
