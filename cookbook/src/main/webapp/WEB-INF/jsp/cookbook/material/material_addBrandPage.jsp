...
<body>
	<form action="materialController/saveBrand.do" name="materialbrandForm" id="materialbrandForm" method="post">
	   ...
	   <input id="imgUrl" name="imgUrl" type="hidden" value="/upload/aaa" />
		...
		<table>
		    ...
		    <tr>
				...
				<td><input type="text" name="name" id="name"  maxlength="32" placeholder="这里输入品牌名称" title="名称"/></td>
			</tr>
			<tr>
