	...
	<head>
		...
		<script type="text/javascript">
			...
			function save(){
			    ...
			    <%--  parent.window.location.href = '<%=basePath%>materialController/findMaterial.do'; --%>
...
<body>
	<form action="materialController/readExcel.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
		<div id="zhongxin">
		<table style="width:95%;" >
			...
			<tr>
				<td style="text-align: center;">
					...
					<a class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>/materialController/downExcel.do'">下载模版</a>
				</td>
			</tr>
		</table>
		</div>
