...
<body>
	<form action="materialController/updateBigCater.do" name="materialbigForm" id="materialbigForm" method="post">
		<input id="bigId" name="bigId" type="hidden" value="${bigId}" />
		<div id="zhongxin" >
		<table>
		    <tr>
		     <td>&nbsp;</td>
		    ...
		    <tr>
				...
				<td><input type="text" name="name" id="name"  maxlength="32" placeholder="这里输入品牌名称" title="名称" value="${materialBigCategoryDto.name}" /></td>
			</tr>
			<tr>
