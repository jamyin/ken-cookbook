...
<body>
	<form action="productionMethod/save.do"  name="productMethodFrom"  id="productMethodFrom"  method="post"  enctype="multipart/form-data">
		<div id="zhongxin">
			<table>
						
		    <tr>
		        <th style="text-align:left;padding-left: 20px;padding-top: 15px;">名称：</th>
				<td style="padding-top: 15px;"><input type="text" name="productionName" id="productionName"  maxlength="32" placeholder="输入成品菜名称" title="名称" style="width: 136px;"/></td>
				<th></th>
				<td></td>				
			</tr>
		  ...
		  <tr>
				...
				<td style="padding-top: 15px;"><input type="file" name="imgUrl"  id="imgUrl"  accept="image/*" /></td>
				<th></th>
				<td></td>				
			</tr>		 
			   <tr>
		        <th style="text-align:left;padding-left: 20px;padding-top: 15px;">制作方法：</th>
				<td style="padding-top: 15px;">							
				<textarea  rows="6" cols="6"  name="productionMethod" id="productionMethod"  maxlength="10000" placeholder="输入成品菜制作方法" title="制作方法" ></textarea>
