package com.ssic.cookbook.admin.controller.system.user;
...
import com.ssic.cookbook.admin.entity.system.Role;
import com.ssic.cookbook.admin.service.system.menu.MenuService;
import com.ssic.cookbook.admin.service.system.role.RoleService;
import com.ssic.cookbook.admin.service.system.user.UserService;
import com.ssic.cookbook.admin.util.AppUtil;
...
import com.ssic.cookbook.admin.util.GetPinyin;
...
import com.ssic.cookbook.admin.util.Tools;
		...
		try{
			if(Jurisdiction.buttonJurisdiction(menuUrl, "cha")){
				...
				for(int i=0;i<userList.size();i++){
					...
					vpd.put("var9", userList.get(i).getString("BZ")); //9
					varList.add(vpd);
				}
	...
	public ModelAndView readExcel(
		...
		if (null != file && !file.isEmpty()) {
			...
			for(int i=0;i<listPd.size();i++){		
				...
				String USERNAME = GetPinyin.getPingYin(listPd.get(i).getString("var2"));	//根据姓名汉字生成全拼
				pd.put("USERNAME", USERNAME);	
