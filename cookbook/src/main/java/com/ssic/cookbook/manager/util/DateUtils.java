...
import com.ssic.cookbook.manager.dto.DateDto;
...
public class DateUtils extends org.apache.commons.lang.time.DateUtils
{
    ...
    public static List<Date> getDatesBetweenTwoDate(Date beginDate, Date endDate) {    
        ...
        int size = lDate.size();
        String dstr1 = dateToStr(lDate.get(size-1), "yyyy-MM-dd");
        String dstr2 = dateToStr(endDate, "yyyy-MM-dd");
        if((size>0) && (!dstr1.equals(dstr2))){
        	lDate.add(endDate);
        }
        return lDate;
    }
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        //			}
        //		}
    	//parse("2016-01-10", "yyyy-MM-dd");
    	
    	Date d1 = parse("2016-01-10", "yyyy-MM-dd");
    	Date d2 = parse("2016-01-10", "yyyy-MM-dd");    	
    	System.out.println(getDatesBetweenTwoDate(d1, d2));
    }
